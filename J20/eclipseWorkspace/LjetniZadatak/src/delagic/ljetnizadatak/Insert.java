	...
	public static void DodavanjeUTablicu() {
		...
		case 4:
			try {
				...
				izraz.setDate(3,
						new java.sql.Date(unosDatum("Unesi datum izdavanja raèuna. Format:" + DATE_FORMAT).getTime()));
				izraz.setDate(4,
						new java.sql.Date(unosDatum("Unesi datum dospijeæa raèuna. Format:" + DATE_FORMAT).getTime()));
